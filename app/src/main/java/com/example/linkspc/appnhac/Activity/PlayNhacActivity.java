...
import com.example.linkspc.appnhac.Adapter.ViewPagerPlaylistnhac;
import com.example.linkspc.appnhac.Fragment.Fragment_Dia_Nhac;
import com.example.linkspc.appnhac.Fragment.Fragment_Play_Danh_Sach_Cac_Bai_Hat;
...
public class PlayNhacActivity extends AppCompatActivity {
    ...
    private void GetDataFromIntent() {
        ...
        mangbaihat.clear();//clear để tránh trường hợp dữ liệu cũ đè lên nhau
        if (intent!=null){
